...
const TaskTable = ({ tableDataProps, hideViewall }) => {
  ...
  return (
    <section className="border-[#BAD6F4] border-2 rounded-xl">
      <div className="flex justify-around h-[4rem] items-center px-4">
          ...
          <div className="flex">
            {navCenterArr.map((n, i) => (
              <p
                ...
                className={` text-[13px] border-[1px] w-[10rem] h-[2rem] flex justify-center first:rounded-l-lg last:rounded-r-lg items-center  ${
                  switchs === i
